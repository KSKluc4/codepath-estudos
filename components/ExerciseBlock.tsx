  ...
  return (
    <div className="card mb-4 exercise-card">
      <div className="card-body">
        ...
        <div
          className="lesson-content mb-3"
          dangerouslySetInnerHTML={{ __html: exercicio.enunciadoHtml }}
        />
        <textarea
        ...
        <div className="accordion" id={accordionId}>
          <div className="accordion-item">
            ...
            <div className={`accordion-collapse collapse`} id={`${accordionId}-collapse`} data-bs-parent={`#${accordionId}`}>
              <div
                className="accordion-body lesson-content"
                dangerouslySetInnerHTML={{ __html: exercicio.solucaoHtml }}
              />
            </div>
          </div>
        </div>
